...
const certificates = [
  ...
  {
    title: "The complete Data Structures and Algorithms in Python",
    issuer: "Udemy",
    icon: "🧠",
    url: "https://www.udemy.com/certificate/UC-64876343-515e-4542-892d-882ede17331e/",
    issued: "Issued June 24, 2025",
  },
];
  ...
  return (
    <div className="flex flex-col items-center my-24">
      <div className="text-center transform transition-all duration-700 hover:scale-105">
        <h2 className="text-4xl font-bold bg-gradient-to-r from-red-600 to-amber-500 text-transparent bg-clip-text inline-block py-2 px-6 rounded-lg shadow-lg hover:shadow-red-500/30 transition-all duration-500 animate-[pulse_3s_ease-in-out_infinite]">Certifications</h2>
      ...
      <section className="px-4 w-full max-w-6xl mx-auto mt-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {certificates.map((cert, idx) => (
            <div key={idx} className="bg-[#1f1f1f] rounded-2xl p-6 shadow-md hover:scale-102 transition-transform hover:shadow-lg hover:shadow-red-500/80 duration-300">
